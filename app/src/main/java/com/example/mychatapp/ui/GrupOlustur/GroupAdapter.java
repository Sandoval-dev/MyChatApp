...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.GrupViewHolder> {
    ...
    public GrupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        GrupViewHolder grupViewHolder=new GrupViewHolder(LayoutInflater.from(parent.getContext()).inflate
                (R.layout.item_grupolustur_grup,parent,false));
    ...
    public class GrupViewHolder extends RecyclerView.ViewHolder{
        ...
        public GrupViewHolder(View itemView){
            ...
            grupImageView=itemView.findViewById(R.id.grupolustur_simge);
            grupnameText=itemView.findViewById(R.id.grupolustur_isim);
            grupaciklamaText=itemView.findViewById(R.id.grupolustur_aciklama);
        }
